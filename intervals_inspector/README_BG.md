...
стойност на минутата, cascade/spillover, `E_z`, динамичен H40 и фиксиран Tref.
Аеробният Tref е начална експертна настройка 300/180/70/20/20 приравнени
минути и не се променя от H40. Резултатите не се записват обратно в Intervals.
