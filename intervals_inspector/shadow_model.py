...
def _tref_values(
    ...
    usable = [row for row in history[-HISTORY_WINDOW_DAYS:] if isinstance(row, Mapping)]
    ...
    return values, history_days, fallback_used
...
def calculate_shadow_result(
    ...
    *,
    ...
    tref_raw, history_days, fallback_used = _tref_values(
        configuration.zones, prior_daily_effective
    )
