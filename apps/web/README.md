...
Next.js App Router frontend for the `training-status-v1` and
`load-history-v1` API contracts. The frontend validates and presents model
output; it does not calculate physiological values.
