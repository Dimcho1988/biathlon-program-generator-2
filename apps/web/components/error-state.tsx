  ...
  return (
    <main className="state-page" role="alert">
      ...
      {(integrationActions || retryAvailable) && <div className="integration-actions">
        ...
        {integrationActions && refreshAvailable && <form action="/api/integrations/intervals/refresh" method="post"><button className="action-button secondary" type="submit">Обнови реалните данни</button></form>}
      </div>}
