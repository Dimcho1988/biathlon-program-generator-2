...
export function PlanningProfileForm({profile,managementProfile,accentPreferences,planningCalendar,notice,athleteAlias}: {
 profile:PlanningProfile|null; managementProfile?:ManagementProfileResponse; methodology?:PlanningMethodology; athleteAlias?:string;
