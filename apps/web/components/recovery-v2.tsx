...
export function RecoveryV2Section({history,canEdit}:{history:RecoveryV2;canEdit:boolean}){
  ...
  return <section className="history-section recovery-section" aria-labelledby="recovery-title">
    ...
    <details className="recovery-provenance"><summary>Защо срокът е такъв? · Дневна история и произход</summary>
      ...
      <p>Срокът за {zone} включва остатъка от всички предишни натоварвания. За всеки ден началната продължителност е товарът E ÷ тогавашната среднодневна база × коефициента за продължителност. При много малка база дори няколко минути могат да дадат дълъг срок.</p>
      ...
      <p>Експертен модел за калибриране. Умората преди началото на наличната история е неизвестна. Версия {history.model.parameter_version}.</p>
    </details>
  </section>;
}
