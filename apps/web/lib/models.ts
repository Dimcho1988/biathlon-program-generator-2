...
export interface RecoveryV2 {
  ...
  model:{algorithm_version:"recovery-daily-e-biexponential-v2";parameter_version:string;parameter_fingerprint:string;practical_full_recovery_percent:90};
...
export function parseRecoveryV2(value:unknown):RecoveryV2 {
  ...
  if(!r || r.schema_version!=="recovery-history-v2" || r.ready_threshold_percent!==90 || r.basis!=="load-only"
    || r.time_resolution!=="calendar-day" || !r.model || r.model.algorithm_version!=="recovery-daily-e-biexponential-v2"
