...
const template: TrainabilityIndex = {
  ...
  "hr_source": "raw",
  "lag_seconds": 20,
  "signal_quality": {"status": "PASSED_SCREEN", "reason": null, "rapid_change_episodes": 0},
  "normalization": "percent_hrmax",
  "comparison_key": "fixture-current-v3",
  "source_versions": {
    "vflat": "vflat_b65_dynamic_v3_uphill150",
    "hrmod": "hrmod_mirror_area_shift_v9"
  },
  "hrmax_bpm": 178,
  "zone_bounds_bpm": [
    50.0,
  ...
  "general": {
    ...
    "mean_hr_bpm": 152.66666666666666,
