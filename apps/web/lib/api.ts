...
export async function getActivityShadow(
  ...
  if (process.env.ONFLOWS_DATA_MODE === "fixture") {
    ...
    return {
      schema_version: "activity-shadow-derived-v3",
      experimental: true,
      ...
      timeseries,
      segments_15s: [],
      sprint_str_summary: { candidate_count: 0, candidate_active_seconds: 0, affects_canonical_load: false, double_counts_hr_zones: false },
