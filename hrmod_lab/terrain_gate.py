...
def _apply_mirror_donor_filter(
    *,
    ...
    # Explicit athlete HRmax belongs to the HR-only profile.  It must never be
    # reconstructed from Z5, observed HR or demographic assumptions.
    hrmax = float(hrmod_result.athlete_hrmax_bpm)
    status_by_sample = [
